...
python Run_k_times_MCS.py k n ref qry


Written by Dang, Academia sinica, Aug 06, 2017.
...
for i in range(int(k)):
	...
	subprocess.call('python ' + dir_path + '/bin/gff_parse_forMCS.py ' + dir_path + '/frag_assemblies/' + ref + 'vs' + qry + '/For_MCS/' + qry + '.' + str(n) + 'kb.coding_gene.gff ' + dir_path + '/data_source/gffs/' + ref + '.coding_gene.gff > ' + str(n) + 'kb.gff', shell=True)
	
	subprocess.call(dir_path + '/bin/MCScanX/MCScanX ' + str(n) + 'kb', shell=True)
	subprocess.call('python ' + dir_path + '/bin/MCS_out_transform.py ' + dir_path + '/frag_assemblies/' + ref + 'vs' + qry + '/For_MCS/' + qry + '.' + str(n) + 'kb.coding_gene.gff ' + dir_path + '/data_source/gffs/' + ref + '.coding_gene.gff ' + str(n) + 'kb.collinearity', shell=True)
