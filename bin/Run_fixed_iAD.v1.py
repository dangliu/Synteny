...
python Run_fixed_iAD.py ref qry


Written by Dang, Academia sinica, Aug 26, 2017.
...
for i in range(int(k)):
	...
	subprocess.call('cp -s ' + dir_path + '/frag_assemblies/' + ref + 'vs' + qry + '/fixed/' + qry + '.' + str(n) + 'kb.coding_gene.gff ./', shell=True)
	...
	subprocess.call('python ' + dir_path + '/bin/iAD_out_transform.py ' + dir_path + '/frag_assemblies/' + ref + 'vs' + qry + '/fixed/' + qry + '.' + str(n) + 'kb.coding_gene.gff ' + dir_path + '/data_source/gffs/' + ref + '.coding_gene.gff segments.txt', shell=True)
