...
# for fixed file input to compare syntenic program output
...
python Run_fixed_DAG.py ref qry
...
for i in range(int(k)):
	...
	subprocess.call('python ' + dir_path + '/bin/match_forDAG.py ' + dir_path + '/frag_assemblies/' + ref + 'vs' + qry + '/fixed/' + qry + '.' + str(n) + 'kb.coding_gene.gff ' + dir_path + '/data_source/gffs/' + ref + '.coding_gene.gff ' + str(n) + 'kb.blast.txt', shell=True)
	# run_process include:
