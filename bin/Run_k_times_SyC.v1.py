...
python Run_k_times_SyC.py k n ref qry


Written by Dang, Academia sinica, Aug 21, 2017.
...
for i in range(int(k)):
	...
	subprocess.call('cp ' + dir_path + '/frag_assemblies/' + ref + 'vs' + qry + '/For_SyC/' + qry + '.' + str(n) + 'kb.coding_gene.gff ./', shell=True)
	...
	subprocess.call('python ' + dir_path + '/bin/SyC_out_transform.py ' + dir_path + '/frag_assemblies/' + ref + 'vs' + qry + '/For_SyC/' + qry + '.' + str(n) + 'kb.coding_gene.gff ' + dir_path + '/data_source/gffs/' + ref + '.coding_gene.gff A_' + qry + '.B_' + ref + '.orth.synt.start_end', shell=True)
